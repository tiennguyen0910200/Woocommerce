...
jQuery(document).ready(function () {
    ...
    function handleColorPicker() {
        ...
        jQuery('.woo-sctr-countdown-timer-color').iris({
            change: function (event, ui) {
                jQuery(this).parent().find('.color-picker').css({backgroundColor: ui.color.toString()});
                jQuery(this).parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({color: ui.color.toString()})
            }
        }).on('keyup', function () {
            jQuery(this).parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({'color': jQuery(this).val()});
            jQuery(this).parent().find('.color-picker').css({'background': jQuery(this).val()});
        });
        jQuery('.woo-sctr-countdown-timer-bg-color').iris({
            change: function (event, ui) {
                jQuery(this).parent().find('.color-picker').css({backgroundColor: ui.color.toString()});
                jQuery(this).parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({backgroundColor: ui.color.toString()})
            }
        }).on('keyup', function () {
            jQuery(this).parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({'background': jQuery(this).val()});
            jQuery(this).parent().find('.color-picker').css({'background': jQuery(this).val()});
        });
        jQuery('.woo-sctr-countdown-timer-border-color').iris({
            change: function (event, ui) {
                jQuery(this).parent().find('.color-picker').css({backgroundColor: ui.color.toString()});
                jQuery(this).parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({'border': '1px solid ' + ui.color.toString()})
            }
        }).on('keyup', function () {
            if (jQuery(this).val() !== '') {
                jQuery(this).parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({'border': '1px solid ' + jQuery(this).val()})
            } else {
    ...
    function handleFontChange() {
        ...
        jQuery('.woo-sctr-countdown-timer-border-radius').unbind().on('change', function () {
            jQuery(this).parent().parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({'border-radius': jQuery(this).val() + 'px'})
        });
        jQuery('.woo-sctr-countdown-timer-padding').unbind().on('change', function () {
            jQuery(this).parent().parent().parent().parent().parent().find('.woo-sctr-shortcode-countdown-1').css({'padding': jQuery(this).val() + 'px'})
        });
