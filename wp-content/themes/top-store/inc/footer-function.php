			...
			<div class="container">
				...
				<div class="below-footer-bar thnk-col-1">
					<div class="below-footer-col1"> 
						<?php top_store_bottom_footer_conetnt_col1($top_store_bottom_footer_col1_set); ?>
						</div>
                </div>
                 <?php elseif($top_store_bottom_footer_layout=='ft-btm-two'):?>
                  <div class="below-footer-bar thnk-col-2">
                   	<div class="below-footer-col1"> <?php top_store_bottom_footer_conetnt_col1($top_store_bottom_footer_col1_set); ?></div>
					<div class="below-footer-col2"> <?php top_store_bottom_footer_conetnt_col2($top_store_bottom_footer_col2_set); ?></div>
				</div>
				<?php elseif($top_store_bottom_footer_layout=='ft-btm-three'):?>
				<div class="below-footer-bar thnk-col-3">
                   	<div class="below-footer-col1"> <?php top_store_bottom_footer_conetnt_col1($top_store_bottom_footer_col1_set); ?></div>
					<div class="below-footer-col2"> <?php top_store_bottom_footer_conetnt_col2($top_store_bottom_footer_col2_set); ?></div>
					<div class="below-footer-col3"> <?php top_store_bottom_footer_conetnt_col3($top_store_bottom_footer_col3_set); ?></div>
				</div>
			<?php endif; ?>
...
//************************************/
if ( ! function_exists( 'top_store_bottom_footer_conetnt_col1' ) ){ 
function top_store_bottom_footer_conetnt_col1($content){ ?>
<?php if($content=='text'){?>
<div class='content-html'>
<?php if(esc_html(get_theme_mod('top_store_footer_bottom_col1_texthtml'))!==''){
echo esc_html(get_theme_mod('top_store_footer_bottom_col1_texthtml'));
}else{?>
<p class="footer-copyright">&copy;
              ...
              <span><?php _e( 'Powered by', 'top-store' ); ?></span>
              <a href="<?php echo esc_url( __( 'https://themehunk.com/', 'top-store' ) ); ?>">
...
//************************************/
if ( ! function_exists( 'top_store_bottom_footer_conetnt_col2' ) ){ 
function top_store_bottom_footer_conetnt_col2($content){ ?>
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('top_store_footer_bottom_col2_texthtml',  __( 'Add your content here', 'top-store' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('top-store-footer-menu' ) ) {?>
<?php 
...
//************************************/
if ( ! function_exists( 'top_store_bottom_footer_conetnt_col3' ) ){ 
function top_store_bottom_footer_conetnt_col3($content){ ?>
<?php if($content=='text'){?>
<div class='content-html'>
  <?php echo esc_html(get_theme_mod('top_store_bottom_footer_col3_texthtml',  __( 'Add your content here', 'top-store' )));?>
</div>
<?php }elseif($content=='menu'){
  if ( has_nav_menu('top-store-footer-menu' ) ) {?>
<?php 
